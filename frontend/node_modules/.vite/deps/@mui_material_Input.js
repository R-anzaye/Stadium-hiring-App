...
function useTheme(defaultTheme4 = null) {
  const contextTheme = React86.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React88.forwardRef(function Box3(inProps, ref) {
...
var ThemeContext2 = React90.createContext(null);
if (true) {
...
function useTheme3() {
  const theme = React91.useContext(ThemeContext_default);
  if (true) {
    React91.useDebugValue(theme);
  }
  return theme;
}
...
var RtlContext = React93.createContext();
...
function createContainer(options = {}) {
  ...
  const Container2 = React98.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React99.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React99.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React99.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime58.jsx)(GridRoot, _extends({
      ...
      children: React99.Children.map(children, (child) => {
        if (React99.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index2) => {
    ...
    if (index2 < childrenArray.length - 1) {
      output.push(React100.cloneElement(separator, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React100.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var InputBase = React102.forwardRef(function InputBase2(inProps, ref) {
  ...
  const inputRef = React102.useRef();
  const handleInputRefWarning = React102.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React102.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime62.jsxs)(React102.Fragment, {
