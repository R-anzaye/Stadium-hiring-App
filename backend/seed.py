...
def seed_pitches():
    pitches = [
        Pitch(
            ...
            image_url='https://example.com/campnou.jpg'
        ),
        Pitch(
            name='Old Trafford',
            ...
            image_url='https://example.com/oldtrafford.jpg'
        ),
        Pitch(
            ...
            image_url='https://example.com/bernabeu.jpg'
        ),
        Pitch(
            name='Allianz Arena',
            ...
            image_url='https://example.com/allianz.jpg'
        ),
        Pitch(
            name='San Siro',
